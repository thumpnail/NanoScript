...
newtype:
	'record' typeargs? ('{' typ '}')? (NAME '=' newtype)* (
		NAME ':' typ
	)* 'end'						# RecordNewType
...
retstat: 'return' explist? ';'? # ReturnStat;
...
args: '(' explist? ')' | tableconstructor | str;
...
str: NORMALSTRING | CHARSTRING | LONGSTRING;
