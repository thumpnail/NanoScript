public class Lexer
{
	...
	public static string[] keywords = {
		"break", "goto", "do", "while", "repeat", "until", "if", 
		"then", "for", "in", "function", "local", "record","enum",
		"type", "global", "return",  "false", "true", "as",  "is", 
		"end","and", "or",  "not","string","boolean", "nil", "number","userdata" };
